...
define(['modules/views/game_view', 'modules/controllers/game_controller', 'modules/models/universe', 'modules/models/inventory', 'modules/models/uiManager', 'modules/views/universe_view'], function(gameView, gameController, Universe, Inventory, uiManager, UniverseView) {
    var game = {};
